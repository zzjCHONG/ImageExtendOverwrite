...
public static class CryptographyExtension
{
    ...
    /// <returns></returns>
    public static string EncryptStringAES(this string input, string password) =>
        CryptographyHelper.EncryptStringAES(input, password);
    ...
    /// <param name="password"></param>
    /// <returns></returns>
    public static string DecryptStringAES(this string input, string password) =>
        CryptographyHelper.DecryptStringAES(input, password);
    ...
    /// <returns></returns>
    public static string EncryptStringRSA(this string input, string publicKey) =>
        CryptographyHelper.EncryptStringRSA(input, publicKey);
    ...
    /// <returns></returns>
    public static string DecryptStringRSA(this string input, string privateKey) =>
        CryptographyHelper.DecryptStringRSA(input, privateKey);
}
