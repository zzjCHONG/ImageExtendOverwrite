...
public static class MicaHelper
{
    ...
    public static bool Apply(this System.Windows.Window window, BackdropType type, bool force = false)
    {
        ...
        if (window is not Lift.UI.Controls.Window)
        {
            void SetStyle()
            {
    ...
    public static void Remove(this System.Windows.Window window)
    {
        ...
        {
            window.SetResourceReference(Lift.UI.Controls.Window.BackgroundProperty, "SecondaryRegionBrush");
        }
    ...
    public static WindowChrome GetWindowChrome(bool isMica)
    {
        ...
        if (_window is Lift.UI.Controls.Window)
        {
