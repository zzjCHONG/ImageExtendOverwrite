...
internal static class PendingEvent
{
    ...
    public static PendingEvent<T> Insert<T>(int index, T item) =>
        new PendingEvent<T>(PendingEventType.Insert, item, index);
    ...
    public static PendingEvent<T> Replace<T>(int index, T item) =>
        new PendingEvent<T>(PendingEventType.Replace, item, index);
