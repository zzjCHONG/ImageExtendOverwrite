...
public class EdgeElement
{
    public static readonly DependencyProperty LeftContentProperty = DependencyProperty.RegisterAttached(
        "LeftContent", typeof(object), typeof(EdgeElement),
        new PropertyMetadata(default(object), OnEdgeContentChanged));
    ...
    public static readonly DependencyProperty RightContentProperty = DependencyProperty.RegisterAttached(
        "RightContent", typeof(object), typeof(EdgeElement),
        new PropertyMetadata(default(object), OnEdgeContentChanged));
    ...
    public static readonly DependencyProperty BottomContentProperty = DependencyProperty.RegisterAttached(
        "BottomContent", typeof(object), typeof(EdgeElement),
        new PropertyMetadata(default(object), OnEdgeContentChanged));
    ...
    public static void SetShowEdgeContent(DependencyObject element, bool value) =>
        element.SetValue(ShowEdgeContentProperty, ValueBoxes.BooleanBox(value));
